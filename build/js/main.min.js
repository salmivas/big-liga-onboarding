...
/* harmony import */ var _modules_switch_frames__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/switch-frames */ "./js/modules/switch-frames.js");
...
Object(_modules_switch_frames__WEBPACK_IMPORTED_MODULE_3__["switchFrameInit"])();
...
var activateMain = function activateMain() {
  header.classList.add('header--active');
  main.classList.add('main--active');
};

var onLoaderClose = function onLoaderClose() {
...
var initModals = function initModals() {
  if (modalLoader) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalLoader, onLoaderClose, false, false, false);
  }
};
...
/***/ "./js/modules/switch-frames.js":
/*!*************************************!*\
  !*** ./js/modules/switch-frames.js ***!
  \*************************************/
/*! exports provided: switchFrameInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchFrameInit", function() { return switchFrameInit; });
var main = document.querySelector('.main');
var wrapper = document.querySelector('.wrapper');
var headerLogo = document.querySelector('.header__logo');
var modal = document.querySelector('.modal');
var minWidthToWorkOn = window.matchMedia('(max-width: 768px)');

var onTabletSizeMatch = function onTabletSizeMatch() {
...
var switchFrames = function switchFrames() {
  main.classList.add('main--customers');
  wrapper.removeEventListener('click', switchFrames);
  wrapper.addEventListener('click', switchBack);
};

var switchFrameInit = function switchFrameInit() {
  onTabletSizeMatch();
...
var onEnterPress = function onEnterPress(evt, modal, callback) {
  var isEnterKey = evt.key === 'Enter' || evt.code === 'Enter';
